...
public class ViewNameUtil {
	...
	public static void setViewName(HttpServletRequest request, ModelAndView mv, String shortViewName) {
		if (isMoblie(request)) {
			mv.setViewName("m-" + shortViewName);
		} else {
			mv.setViewName("pc-" + shortViewName);
		}
	}
